<%@ Page Title="" Language="C#" MasterPageFile="~/Materias/MasterPage.master" AutoEventWireup="true" CodeBehind="PublicarMateria.aspx.cs" Inherits="AgenciaNoticasN.Materias.PublicarMateria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12 form-inline">
            ...
            <asp:TextBox ID="txtDataPublicacao" runat="server" CssClass="form-control"></asp:TextBox>--%>
            <asp:LinkButton ID="lkPublicar" runat="server" Text="Publicar matéria" CssClass="btn btn-primary pull-right" OnClick="lkPublicar_Click"></asp:LinkButton>
        </div>
